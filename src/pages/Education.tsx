...
export default function Education() {
  const education = [
    {
      ...
      period: "2023–2026",
      details:
        "Research: Enhancing Disease Diagnosis with AI-Powered Genomic Analysis",
    },
    {
      ...
      period: "2020–2023",
      details:
        "Research: Improving Pattern Matching Algorithms for Biological Sequences",
    },
    {
  ...
  const awards = [
    ...
    },
    {
      ...
      period: "June 2019",
      details:
        "Graduated Very Good with Degree of Honor (GPA 3.45) out of 70 students",
    },
    {
    ...
    <Layout>
      <PageTransition className="flex-1 max-w-5xl mx-auto w-full px-4 py-16 space-y-24">
        <AnimateIn direction="up">
          <h1 className="text-4xl md:text-5xl font-bold font-serif mb-12 text-foreground">
            Education & Awards
          </h1>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <h2 className="text-2xl font-serif border-b border-border pb-2 text-primary">
                Academic Background
              </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center items-center gap-4 mt-8">
              ...
              <button
                ...
                className="h-7 w-7 rounded-full border border-primary/40 flex items-center justify-center text-primary transition-colors hover:bg-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
